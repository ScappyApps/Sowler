(function ($, window, document, undefined) {
	...
	$.extend(Plugin.prototype, {
		...
		_renderCheckBox: function() {
			$(this.element).find('.weather__checkbox').attr('src', theme_url + `/img/dialog_checkbox${this.settings.fixLocation ? '_selected' : ''}.png`);
		},
		...
		_render: function(obj) {
			...
			if (obj) {
				...
				<img class="weather__checkbox" title="Fix this city" src="` + theme_url + `img/dialog_checkbox${this.settings.fixLocation ? '_selected' : ''}.png">
				<span class="weather__name-city" title="Click to select another city">${obj.name}, ${obj.country}</span><br>
				<div class="weather__wrapper">
				<img class="weather__img" title="${obj.description}" src="` + theme_url + `img/${this._icons[obj.icon]}.png"><br>
				...
				.css(`background`, `url("` + theme_url + `img/${obj.icon}.jpg")`)
