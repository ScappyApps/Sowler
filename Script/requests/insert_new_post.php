...
if (isset($_POST['background']) && !empty($_POST['background']) && strlen($_POST['postText']) <= 130) {
...
if (!empty($_POST['html_url']) && empty($_FILES['media_empty']['name']) && empty($_POST['postGif']) && empty($_POST['background']) && empty($_POST['postSticker'])) {
